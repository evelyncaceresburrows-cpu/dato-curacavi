...
export const COMERCIOS: Comercio[] = [
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "20:00",
    imagen: "linear-gradient(135deg, #D97706, #F2C98A 55%, #FDE4C1)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "22:00",
    imagen: "linear-gradient(135deg, #7a4203, #D97706 55%, #FDE4C1)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "21:00",
    imagen: "linear-gradient(135deg, #6b4423, #a07043 45%, #d4b494)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "23:00",
    imagen: "linear-gradient(135deg, #4a2b1a, #7d4b2e 50%, #b67a4a)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "22:00",
    imagen: "linear-gradient(135deg, #6b4423, #8b5e34 45%, #c08552 100%)",
  ...
  },
  {
    ...
    estado: "verificado",
    abiertoHasta: "20:00",
    imagen: "linear-gradient(135deg, #8b4a1a, #c38536 55%, #e8c48a)",
  ...
  },
  {
    ...
    estado: "verificado",
    abiertoHasta: "21:00",
    imagen: "linear-gradient(135deg, #c38536, #e8c48a 60%, #f5e3c0)",
  ...
  },
  {
    ...
    estado: "verificado",
    abiertoHasta: "14:00",
    imagen: "linear-gradient(135deg, #4CA772, #a7d3b4 55%, #e6e4bb)",
  ...
  },
  {
    ...
    estado: "verificado",
    abiertoHasta: "18:00",
    imagen: "linear-gradient(135deg, #2F5AA0, #6b8fca 55%, #c8d6ed)",
  ...
  },
  {
    ...
    estado: "verificado",
    abiertoHasta: "19:00",
    imagen: "linear-gradient(135deg, #555, #7c7c7c 60%, #a0a0a0)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "17:00",
    imagen: "linear-gradient(135deg, #2D8F8A, #5fb5ae 55%, #b7dbd6)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "24h",
    imagen: "linear-gradient(135deg, #B13A3A, #d87171 55%, #f0b3b3)",
  ...
  },
  {
    ...
    estado: "socio_pro",
    abiertoHasta: "24h",
    imagen: "linear-gradient(135deg, #7a1414, #b13a3a 55%, #d87171)",
...
export const EVENTOS: Evento[] = [
  ...
  },
  {
    ...
    chipColor: "#FADBC1",
    imagen: "linear-gradient(135deg, #2D5A27, #4F8748 40%, #bcd48a 75%, #f3e0b5)",
    estado: "socio_pro",
    gratis: true,
  },
  {
